            ...
            {!isExpanded ? (
              <View className="flex-row items-center">
                ...
                {supportsAutoSwitch || autoSwitchEnabled ? (
                  <Pressable
                    accessibilityLabel="Automatic account switching"
                    ...
                    accessibilityHint="Switch to a compatible account when a usage limit or disabled subscription access interrupts the session."
