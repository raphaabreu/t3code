...
import { AutomaticCredentialSelectorLive } from "./orchestration/Layers/AutomaticCredentialSelector.ts";
...
const AutomaticProviderReactorLayerLive = Layer.mergeAll(
  ProviderRuntimeIngestionLive,
  ProviderCommandReactorLive,
).pipe(Layer.provideMerge(AutomaticCredentialSelectorLive));

const ReactorLayerLive = Layer.empty.pipe(
  Layer.provideMerge(OrchestrationReactorLive),
  Layer.provideMerge(AutomaticProviderReactorLayerLive),
